...
SMTP_PORT = 587
EMAIL_USER = os.getenv('EMAIL_USER')  # REQUERIDO: Configurar en variables de entorno
EMAIL_PASSWORD = os.getenv('EMAIL_PASSWORD')  # REQUERIDO: App Password de Gmail
DESTINATION_EMAIL = "solucionesworld2016@gmail.com"
EMAIL_SUBJECT = "ImpactoDigitalSPM - Evalucacion COMPLETADA"
